...
class ListAuthorizationsSettlementResponse extends JsonSerializableType
{
    use PaginatedList;

    /**
     * @var array<Authorization> $data Array of authorization objects.
     */
    #[JsonProperty('data'), ArrayType([Authorization::class])]
    public array $data;
