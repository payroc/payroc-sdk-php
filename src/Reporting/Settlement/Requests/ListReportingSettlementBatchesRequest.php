...
class ListReportingSettlementBatchesRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var DateTime $date Filter batches by the date that they were submitted. The format of this value is **YYYY-MM-DD**.
     */
