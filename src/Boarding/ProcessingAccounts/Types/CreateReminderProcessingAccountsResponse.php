...
class CreateReminderProcessingAccountsResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'pricingAgreement'
     ...
     */
    public static function pricingAgreement(PricingAgreementReminder $pricingAgreement): CreateReminderProcessingAccountsResponse
    {
        return new CreateReminderProcessingAccountsResponse([
