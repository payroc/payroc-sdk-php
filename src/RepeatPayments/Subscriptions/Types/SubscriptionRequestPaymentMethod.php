 ...
 */
class SubscriptionRequestPaymentMethod extends JsonSerializableType
{
    /**
     * @var (
     *    'secureToken'
     ...
     * @return SubscriptionRequestPaymentMethod
     */
    public static function secureToken(SecureTokenPayload $secureToken): SubscriptionRequestPaymentMethod
    {
        return new SubscriptionRequestPaymentMethod([
            'type' => 'secureToken',
            'value' => $secureToken,
        ]);
    }
