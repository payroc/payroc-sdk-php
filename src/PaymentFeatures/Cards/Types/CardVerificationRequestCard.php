 ...
 */
class CardVerificationRequestCard extends JsonSerializableType
{
    /**
     * @var (
     *    'card'
     ...
     * @return CardVerificationRequestCard
     */
    public static function card(CardPayload $card): CardVerificationRequestCard
    {
        return new CardVerificationRequestCard([
            'type' => 'card',
            'value' => $card,
        ]);
    }
