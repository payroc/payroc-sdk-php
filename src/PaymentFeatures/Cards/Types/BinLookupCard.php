...
use Payroc\Types\CardBinPayload;
...
class BinLookupCard extends JsonSerializableType
{
     ...
     * @return BinLookupCard
     */
    public static function card(CardPayload $card): BinLookupCard
    {
        return new BinLookupCard([
            'type' => 'card',
            'value' => $card,
        ]);
    }
    ...
    /**
     * @param CardBinPayload $cardBin
     * @return BinLookupCard
     */
    public static function cardBin(CardBinPayload $cardBin): BinLookupCard
    {
        return new BinLookupCard([
            'type' => 'cardBin',
            'value' => $cardBin,
     ...
     * @return BinLookupCard
     */
    public static function secureToken(SecureTokenPayload $secureToken): BinLookupCard
    {
        return new BinLookupCard([
            'type' => 'secureToken',
            'value' => $secureToken,
     ...
     * @return BinLookupCard
     */
    public static function digitalWallet(DigitalWalletPayload $digitalWallet): BinLookupCard
    {
        return new BinLookupCard([
            'type' => 'digitalWallet',
            'value' => $digitalWallet,
     ...
     * @return bool
     */
    public function isCardBin(): bool
    {
        return $this->value instanceof CardBinPayload && $this->type === 'cardBin';
    }

    /**
     * @return CardBinPayload
     */
    public function asCardBin(): CardBinPayload
    {
        if (!($this->value instanceof CardBinPayload && $this->type === 'cardBin')) {
            throw new Exception(
                "Expected cardBin; got " . $this->type . " with value of type " . get_debug_type($this->value),
            );
        }
    ...
    public function jsonSerialize(): array
    {
        ...
        switch ($this->type) {
            case 'card':
                ...
                break;
            case 'cardBin':
                $value = $this->asCardBin()->jsonSerialize();
                $result = array_merge($value, $result);
                break;
            case 'secureToken':
    ...
    public static function jsonDeserialize(array $data): static
    {
        ...
        switch ($type) {
            case 'card':
                ...
                break;
            case 'cardBin':
                $args['value'] = CardBinPayload::jsonDeserialize($data);
                break;
            case 'secureToken':
