...
namespace Payroc\PaymentFeatures\Bank\Types;
...
class BankAccountVerificationRequestBankAccount extends JsonSerializableType
{
     ...
     * @return BankAccountVerificationRequestBankAccount
     */
    public static function ach(AchPayload $ach): BankAccountVerificationRequestBankAccount
    {
        return new BankAccountVerificationRequestBankAccount([
            'type' => 'ach',
            'value' => $ach,
        ]);
    }
     ...
     * @return BankAccountVerificationRequestBankAccount
     */
    public static function pad(PadPayload $pad): BankAccountVerificationRequestBankAccount
    {
        return new BankAccountVerificationRequestBankAccount([
            'type' => 'pad',
            'value' => $pad,
