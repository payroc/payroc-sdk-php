 ...
 */
class BankTransferRefundBankAccount extends JsonSerializableType
{
    /**
     * @var (
     *    'ach'
     ...
     * @return BankTransferRefundBankAccount
     */
    public static function ach(AchBankAccount $ach): BankTransferRefundBankAccount
    {
        return new BankTransferRefundBankAccount([
            'type' => 'ach',
            'value' => $ach,
        ]);
    }
     ...
     * @return BankTransferRefundBankAccount
     */
    public static function pad(PadBankAccount $pad): BankTransferRefundBankAccount
    {
        return new BankTransferRefundBankAccount([
            'type' => 'pad',
            'value' => $pad,
