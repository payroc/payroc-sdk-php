...
class PaymentLinkPaginatedListDataItem extends JsonSerializableType
{
    /**
     * @var (
     *    'multiUse'
     ...
     * @return PaymentLinkPaginatedListDataItem
     */
    public static function multiUse(MultiUsePaymentLink $multiUse): PaymentLinkPaginatedListDataItem
    {
        return new PaymentLinkPaginatedListDataItem([
            'type' => 'multiUse',
            'value' => $multiUse,
        ]);
    }
     ...
     * @return PaymentLinkPaginatedListDataItem
     */
    public static function singleUse(SingleUsePaymentLink $singleUse): PaymentLinkPaginatedListDataItem
    {
        return new PaymentLinkPaginatedListDataItem([
            'type' => 'singleUse',
            'value' => $singleUse,
