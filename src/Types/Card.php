...
class Card extends JsonSerializableType
{
    ...
    /**
     * @var value-of<CardEntryMethod> $entryMethod Method that the device used to capture the card details.
     */
    ...
    /**
     * @var string $cardNumber Card number. In the response, our gateway shows only the first six digits and the last four digits of the card number, for example, 500165******0000.
     */
     ...
     * @param array{
     *   type: string,
     *   entryMethod: value-of<CardEntryMethod>,
     *   cardNumber: string,
     *   expiryDate: string,
