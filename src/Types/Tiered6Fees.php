 ...
 */
class Tiered6Fees extends JsonSerializableType
{
    /**
     * @var QualRatesWithPremiumAndRegulated $mastercardVisaDiscover Object that contains the fees for Mastercard, Visa, and Discover transactions.
     */
    #[JsonProperty('mastercardVisaDiscover')]
    public QualRatesWithPremiumAndRegulated $mastercardVisaDiscover;

    /**
     * @var ?Tiered6FeesAmex $amex Object that contains the fees for American Express transactions.
     */
    #[JsonProperty('amex')]
    public ?Tiered6FeesAmex $amex;
    ...
    /**
     * @param array{
     *   mastercardVisaDiscover: QualRatesWithPremiumAndRegulated,
     *   amex?: ?Tiered6FeesAmex,
     *   pinDebit?: ?PinDebit,
