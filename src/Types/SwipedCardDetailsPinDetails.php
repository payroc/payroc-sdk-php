...
class SwipedCardDetailsPinDetails extends JsonSerializableType
{
    /**
     * @var (
     *    'dukpt'
     ...
     * @return SwipedCardDetailsPinDetails
     */
    public static function dukpt(DukptPinDetails $dukpt): SwipedCardDetailsPinDetails
    {
        return new SwipedCardDetailsPinDetails([
            'dataFormat' => 'dukpt',
            'value' => $dukpt,
        ]);
    }
