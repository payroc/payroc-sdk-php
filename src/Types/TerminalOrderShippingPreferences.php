 ...
 */
class TerminalOrderShippingPreferences extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?value-of<TerminalOrderShippingPreferencesMethod> $method
     */
    #[JsonProperty('method')]
    ...
    /**
     * @param array{
     *   method?: ?value-of<TerminalOrderShippingPreferencesMethod>,
