...
class FiveHundred extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<FiveHundredErrorsItem> $errors
     */
    #[JsonProperty('errors'), ArrayType([FiveHundredErrorsItem::class])]
    public ?array $errors;
     ...
     *   status: int,
     *   detail: string,
     *   errors?: ?array<FiveHundredErrorsItem>,
     * } $values
     */
