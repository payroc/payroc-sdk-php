 ...
 */
class InterchangePlusPlusUs52FeesAmex extends JsonSerializableType
{
    /**
     * @var (
     *    'optBlue'
     ...
     * @return InterchangePlusPlusUs52FeesAmex
     */
    public static function optBlue(InterchangePlusPlusAmexOptBlue $optBlue): InterchangePlusPlusUs52FeesAmex
    {
        return new InterchangePlusPlusUs52FeesAmex([
            'type' => 'optBlue',
            'value' => $optBlue,
        ]);
    }
     ...
     * @return InterchangePlusPlusUs52FeesAmex
     */
    public static function direct(InterchangePlusPlusAmexDirect $direct): InterchangePlusPlusUs52FeesAmex
    {
        return new InterchangePlusPlusUs52FeesAmex([
            'type' => 'direct',
            'value' => $direct,
