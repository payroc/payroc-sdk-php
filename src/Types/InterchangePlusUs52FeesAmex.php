 ...
 */
class InterchangePlusUs52FeesAmex extends JsonSerializableType
{
    /**
     * @var (
     *    'optBlue'
     ...
     * @return InterchangePlusUs52FeesAmex
     */
    public static function optBlue(InterchangePlusAmexOptBlue $optBlue): InterchangePlusUs52FeesAmex
    {
        return new InterchangePlusUs52FeesAmex([
            'type' => 'optBlue',
            'value' => $optBlue,
        ]);
    }
     ...
     * @return InterchangePlusUs52FeesAmex
     */
    public static function direct(InterchangePlusAmexDirect $direct): InterchangePlusUs52FeesAmex
    {
        return new InterchangePlusUs52FeesAmex([
            'type' => 'direct',
            'value' => $direct,
