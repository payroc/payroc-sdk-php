 ...
 */
class SecureToken extends JsonSerializableType
{
    /**
    ...
    /**
     * @var SecureTokenSource $source Object that contains information about the payment method that we tokenized.
     */
    #[JsonProperty('source')]
    public SecureTokenSource $source;
