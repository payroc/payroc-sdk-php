...
class SingleUsePaymentLinkOrderCharge extends JsonSerializableType
{
     ...
     * @return SingleUsePaymentLinkOrderCharge
     */
    public static function prompt(PromptPaymentLinkCharge $prompt): SingleUsePaymentLinkOrderCharge
    {
        return new SingleUsePaymentLinkOrderCharge([
            'type' => 'prompt',
            'value' => $prompt,
        ]);
    }
     ...
     * @return SingleUsePaymentLinkOrderCharge
     */
    public static function preset(PresetPaymentLinkCharge $preset): SingleUsePaymentLinkOrderCharge
    {
        return new SingleUsePaymentLinkOrderCharge([
            'type' => 'preset',
            'value' => $preset,
