 ...
 */
class SingleUseTokenSource extends JsonSerializableType
{
    /**
     * @var (
     *    'ach'
    ...
    /**
     * @param AchSource $ach
     * @return SingleUseTokenSource
     */
    public static function ach(AchSource $ach): SingleUseTokenSource
    {
        return new SingleUseTokenSource([
            'type' => 'ach',
            'value' => $ach,
        ]);
    }
     ...
     * @return SingleUseTokenSource
     */
    public static function pad(PadSource $pad): SingleUseTokenSource
    {
        return new SingleUseTokenSource([
            'type' => 'pad',
            'value' => $pad,
     ...
     * @return SingleUseTokenSource
     */
    public static function card(CardSource $card): SingleUseTokenSource
    {
        return new SingleUseTokenSource([
            'type' => 'card',
            'value' => $card,
