 ...
 */
class GatewayUsFees extends JsonSerializableType
{
    /**
    ...
    /**
     * @var int $additionalServiceMonthly Monthly fee for additional service. The value is in the currency's lowest denomination, for example, cents.
     */
    #[JsonProperty('additionalServiceMonthly')]
    public int $additionalServiceMonthly;
    ...
    public function __construct(
        ...
        $this->additionalServiceMonthly = $values['additionalServiceMonthly'];
    }
