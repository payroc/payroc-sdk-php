...
class SingleUseTokenPayloadPinDetails extends JsonSerializableType
{
     ...
     * @return SingleUseTokenPayloadPinDetails
     */
    public static function dukpt(DukptPinDetails $dukpt): SingleUseTokenPayloadPinDetails
    {
        return new SingleUseTokenPayloadPinDetails([
            'dataFormat' => 'dukpt',
            'value' => $dukpt,
        ]);
    }
    ...
    /**
     * @param RawPinDetails $raw
     * @return SingleUseTokenPayloadPinDetails
     */
    public static function raw(RawPinDetails $raw): SingleUseTokenPayloadPinDetails
    {
        return new SingleUseTokenPayloadPinDetails([
            'dataFormat' => 'raw',
            'value' => $raw,
    ...
    {
        return $this->value instanceof RawPinDetails && $this->dataFormat === 'raw';
    }

    /**
     * @return RawPinDetails
     */
    public function asRaw(): RawPinDetails
    {
        if (!($this->value instanceof RawPinDetails && $this->dataFormat === 'raw')) {
            throw new Exception(
                "Expected raw; got " . $this->dataFormat . " with value of type " . get_debug_type($this->value),
            );
        }
    ...
    public static function jsonDeserialize(array $data): static
    {
        ...
        switch ($dataFormat) {
            case 'dukpt':
                ...
                break;
            case 'raw':
                $args['value'] = RawPinDetails::jsonDeserialize($data);
                break;
            case '_unknown':
            default:
