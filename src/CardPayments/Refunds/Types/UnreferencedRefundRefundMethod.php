 ...
 */
class UnreferencedRefundRefundMethod extends JsonSerializableType
{
    /**
     * @var (
     *    'card'
     ...
     * @return UnreferencedRefundRefundMethod
     */
    public static function card(CardPayload $card): UnreferencedRefundRefundMethod
    {
        return new UnreferencedRefundRefundMethod([
            'type' => 'card',
            'value' => $card,
        ]);
    }
     ...
     * @return UnreferencedRefundRefundMethod
     */
    public static function secureToken(SecureTokenPayload $secureToken): UnreferencedRefundRefundMethod
    {
        return new UnreferencedRefundRefundMethod([
            'type' => 'secureToken',
            'value' => $secureToken,
