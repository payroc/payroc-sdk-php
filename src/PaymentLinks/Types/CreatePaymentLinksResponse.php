...
class CreatePaymentLinksResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'multiUse'
     ...
     */
    public static function multiUse(MultiUsePaymentLink $multiUse): CreatePaymentLinksResponse
    {
        return new CreatePaymentLinksResponse([
            'type' => 'multiUse',
            'value' => $multiUse,
        ]);
    }
     ...
     * @return CreatePaymentLinksResponse
     */
    public static function singleUse(SingleUsePaymentLink $singleUse): CreatePaymentLinksResponse
    {
        return new CreatePaymentLinksResponse([
            'type' => 'singleUse',
            'value' => $singleUse,
