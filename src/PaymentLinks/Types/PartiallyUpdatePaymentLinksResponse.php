...
class PartiallyUpdatePaymentLinksResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'multiUse'
     ...
     */
    public static function multiUse(MultiUsePaymentLink $multiUse): PartiallyUpdatePaymentLinksResponse
    {
        return new PartiallyUpdatePaymentLinksResponse([
            'type' => 'multiUse',
            'value' => $multiUse,
        ]);
    }
     ...
     * @return PartiallyUpdatePaymentLinksResponse
     */
    public static function singleUse(SingleUsePaymentLink $singleUse): PartiallyUpdatePaymentLinksResponse
    {
        return new PartiallyUpdatePaymentLinksResponse([
            'type' => 'singleUse',
            'value' => $singleUse,
