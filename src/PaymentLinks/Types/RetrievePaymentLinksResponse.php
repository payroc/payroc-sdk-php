...
class RetrievePaymentLinksResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'multiUse'
     ...
     */
    public static function multiUse(MultiUsePaymentLink $multiUse): RetrievePaymentLinksResponse
    {
        return new RetrievePaymentLinksResponse([
            'type' => 'multiUse',
            'value' => $multiUse,
        ]);
    }
     ...
     * @return RetrievePaymentLinksResponse
     */
    public static function singleUse(SingleUsePaymentLink $singleUse): RetrievePaymentLinksResponse
    {
        return new RetrievePaymentLinksResponse([
            'type' => 'singleUse',
            'value' => $singleUse,
