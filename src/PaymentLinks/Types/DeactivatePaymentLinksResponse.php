...
class DeactivatePaymentLinksResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'multiUse'
     ...
     */
    public static function multiUse(MultiUsePaymentLink $multiUse): DeactivatePaymentLinksResponse
    {
        return new DeactivatePaymentLinksResponse([
            'type' => 'multiUse',
            'value' => $multiUse,
        ]);
    }
     ...
     * @return DeactivatePaymentLinksResponse
     */
    public static function singleUse(SingleUsePaymentLink $singleUse): DeactivatePaymentLinksResponse
    {
        return new DeactivatePaymentLinksResponse([
            'type' => 'singleUse',
            'value' => $singleUse,
